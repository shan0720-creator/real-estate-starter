...
const Search = () => {
  ...
  console.log(houses);
  return <div className='px-[30px] py-6 max-w-[1170px] mx-auto flex flex-col lg:flex-row justify-between gap-4 lg:gap-x-3 relative lg:-top-4 lg:shadow-1 lg:backdrop-blur rounded-lg'>
    <CountryDropdown />
    <PropertyDropdown/>
    <DateDrop/>
    <PriceRangeDropdown/>
